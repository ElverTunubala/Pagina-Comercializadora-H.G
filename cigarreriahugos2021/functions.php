...
function create_post_type_html5()
{
    ...
    register_post_type('productos', // Register Custom Post Type
        array(
        'labels' => array(
            'name' => __('Productos', 'html5blank'), // Rename these to suit
            'singular_name' => __('Productos', 'html5blank'),
            'add_new' => __('Add New', 'html5blank'),
            'add_new_item' => __('Add New Productos', 'html5blank'),
            'edit' => __('Edit', 'html5blank'),
            'edit_item' => __('Edit Productos', 'html5blank'),
            'new_item' => __('New Productos', 'html5blank'),
            'view' => __('View Productos', 'html5blank'),
            'view_item' => __('View Productos', 'html5blank'),
            'search_items' => __('Search Productos', 'html5blank'),
            'not_found' => __('No se encontraron Productos ', 'html5blank'),
